...
<template>
  <div class="page">
    <div class="section-head">
      <div><div class="eyebrow">Área do autor</div><h2>Meus recursos</h2><p>Todos os recursos publicados pelo REA.fed na sua conta Pleroma.</p></div>
      <div style="display:flex;gap:10px;align-items:center">
        <button class="btn ghost" type="button" :disabled="loading" @click="loadResources"><RefreshCw :size="16" :class="loading ? 'spin' : ''" /> Atualizar</button>
